...
import project.FpQuantApp;
import project.domain.PersistentToken;
import project.domain.User;
import project.repository.PersistentTokenRepository;
...
@SpringBootTest(classes = FpQuantApp.class)
@Transactional
